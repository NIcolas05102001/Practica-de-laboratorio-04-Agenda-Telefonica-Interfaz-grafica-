...
public class Ventanas {
    ...
    public void ventana5() {
        ...
        Ventana v = new Ventana("Opciones telefono", 600, 400);

        Panel p = new Panel();

        GridLayout m = new GridLayout(4, 1);

        Button[] buttons = new Button[4];

        buttons[0] = new Button("Registrar");
        buttons[1] = new Button("Modificar");
        buttons[2] = new Button("Eliminar");
        buttons[3] = new Button("Listar");
    ...
    public void ventana6() {
        ...
        Ventana v = new Ventana("Registro telefono", 600, 400);
        ...
        labels[0]= new Label("Codigo");
        labels[1]= new Label("Numero");
        labels[2]= new Label("Tipo");
        labels[3]= new Label("Operadora");
        
        for (int i = 0; i < 4; i++) {
            fields[i] = new TextField(10);
        }
